...
public class SharedRegisterActivity extends AppCompatActivity {
    Intent next_activity;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.shared_activity_register);
        next_activity=new Intent(this, SharedMainActivity.class);
        ...
        registerbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(SharedRegisterActivity.this,"Passwords don't match",Toast.LENGTH_LONG).show();
                }
